...
// That is reserved for accessors.  What this does provide
// is a way to get to the beginning of a row, as well as 
// knowing the dimesions.
//
struct PixelArray
{
...
/*
// Just holding this for a minute to see if we can 
// re-seat the PixelAccessor onto the PixelArray
