...
public:
    ...
    */
    ...
    double BEZ03(float u) {return powf(1.0f-u, 3); }            // (1-u)^3
    double BEZ13(float u) {return (3.0f*u)*((1.0f-u) * (1.0f-u));}    // 3u(1-u)^2
    double BEZ23(float u) {return 3.0f * (u*u) * (1.0f-u);}          // 3u^2(1-u)
    double BEZ33(float u) {return u*u*u;}                  // u^3
